...
module.exports = inherit({
     ...
     */
    __constructor: function (sources) {
    ...
    getDeps: function (decl) {
        ...
        function keepWorking(file) {
            return vowFs.read(file.fullname, 'utf8').then(function (depContent) {
                var depsStructure = this._formatIndex[file.suffix].processFile(file.fullname, depContent);
